...
//    )
//
//    whenever(friendGroupRepositoryMock.findByIdAndUserId(friendGroup.id)).thenReturn(Mono.just(friendGroup))
...
//    )
//
//    whenever(friendGroupRepositoryMock.findByIdAndUserId(friendGroup.id)).thenReturn(Mono.empty())
//
//    //when
